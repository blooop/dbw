...
class DockerRunner:
    ...
    def check_docker_available(self) -> None:
        ...
        try:
            ...
            raise DockerUnavailable("Docker not found. Please install Docker.") from exc
    ...
    def check_buildx_available(self) -> None:
        ...
        try:
            ...
            raise DockerError("Docker Buildx not found.") from exc
    ...
    def check_compose_available(self) -> None:
        ...
        try:
            ...
            raise DockerError("Docker Compose not found.") from exc
    ...
    def build_images(self, force_rebuild: bool = False) -> None:
        ...
        try:
            ...
            raise DockerError(f"Failed to build images: {e}") from e
    ...
    def exec_command(
        ...
        try:
            ...
            if interactive:
                result = subprocess.run(cmd, cwd=self.worktree_path, env=env, check=False)
