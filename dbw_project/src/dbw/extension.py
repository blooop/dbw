...
class ExtensionCache:
    ...
    def list_extensions(self) -> List[str]:
        ...
        return [
            d.name for d in self.extensions_dir.iterdir()
    ...
    def _download_extension(self, name: str, url: str, ext_path: Path) -> None:
        ...
        try:
            ...
            raise ExtensionError(f"Failed to download extension from {url}: {e}")
    
    def _copy_extension(self, name: str, source_path: Path, ext_path: Path) -> None:
    ...
    def _validate_extension(self, name: str) -> None:
        ...
        try:
            ...
            raise ExtensionInvalid(f"Invalid YAML in extension {name}: {e}")
...
"""
        ...
        try:
            ...
            raise ExtensionError(f"Failed to build extension {name}: {e.stderr}")
